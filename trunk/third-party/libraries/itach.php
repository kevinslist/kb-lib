...
class itach {
  ...
  static function init($get_command = NULL) {
    /*
    $url = self::$base_url . $get_command;
    $r = self::get($url);
    print $r . '<br />';
    */
    $set1 = self::$base_url . 'irports/1/sendir';
    
  
    $commands[$set1] = array(
                        'frequency' => "38369",
                        'preamble'  => '',
                        'irCode'    => '343,171,19,86,19,86,19,171,19,171,19,86,19,86,19,86,19,86,19,86,19,86,19,86,19,86,19,86,19,86,19,171,19,86,19,1336,343,86,19,3353,343,86,19,3353,343,86,19,3353,343,86,19,3353,343,86,19,3353,343,86,19,3353,343,86,19,3836',
                        'repeat'    => '1'
                      );
    //[cable_channel_down]	sendir,1:1,1,38369,1,1,343,171,19,86,19,86,19,171,19,171,19,86,19,86,19,86,19,86,19,86,19,86,19,86,19,86,19,86,19,86,19,171,19,86,19,1336,343,86,19,3353,343,86,19,3353,343,86,19,3353,343,86,19,3353,343,86,19,3353,343,86,19,3353,343,86,19,3836

    $r = self::post($commands);
   /**/
    return;
  }
