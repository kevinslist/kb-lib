...
class process_rtl433 {
  ...
  static $script_command1 = NULL;
  static $script_command2 = NULL;
  ...
  static function start($app_directory = NULL, $arg = NULL) {
    ...
    self::$script_command2 = $app_directory . '/third_party/kb/builds/rtl443/build/src/rtl_433 -d 1 -a -D 2>&1';
    self::$process2 = proc_open(self::$script_command2, self::$descriptorspec, self::$pipes2);
